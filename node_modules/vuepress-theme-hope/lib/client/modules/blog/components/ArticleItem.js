...
export default defineComponent({
    ...
    setup(props, { slots }) {
        ...
        return () => {
            const { ["t" /* ArticleInfoType.title */]: title, ["y" /* ArticleInfoType.type */]: type, ["n" /* ArticleInfoType.isEncrypted */]: isEncrypted, ["v" /* ArticleInfoType.cover */]: cover, ["e" /* ArticleInfoType.excerpt */]: excerpt, ["u" /* ArticleInfoType.sticky */]: sticky, } = articleInfo.value;
