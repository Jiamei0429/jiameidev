...
export default defineComponent({
    ...
    setup(_props, { slots }) {
        ...
        const heroInfo = computed(() => {
            const { heroText, heroImage, heroImageDark, heroAlt, heroImageStyle, tagline = null, } = frontmatter.value;
            return {
        ...
        return () => frontmatter.value.hero === false
            ...
            : h("div", {
                ...
                slots["heroInfo"]?.(heroInfo.value) || [
                    ...
                    h(DropTransition, { appear: true, delay: 0.08 }, () => heroInfo.value.text ? h("h1", heroInfo.value.text) : null),
