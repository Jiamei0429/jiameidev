import{_ as e,Y as n,Z as i,a3 as s}from"./framework-5ec5f799.js";const d={},a=s(`<h1 id="发布npm软件包" tabindex="-1"><a class="header-anchor" href="#发布npm软件包" aria-hidden="true">#</a> 发布NPM软件包 🎉</h1><p>第一步：</p><p>去官网注册自己的账号</p><p>https://registry.npmjs.org/</p><p>第二部：</p><p>在文件根目录下执行npm init，进行初始化</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>package name: (node_server_ts)
version: (1.0.0) 1.0.1                                                                                                                                                                                                             
